...
$from = $_GET['from'];
$to = $_GET['to'];
$sql = "SELECT * FROM tbl_member WHERE mem_status=1 AND mem_registerdate BETWEEN '$from' AND '$to' ";
...
<div class="container">
     <div class="jumbotron">
	   ...
	   <div style="float:left">
         <a class="btn  btn-primary" href="printmemberbydate.php?from=<?php echo $from ?>&to=<?php echo $to ?>" target="_blank" role="button"> <i class="fa fa-print"></i> Print</a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <?php $file = '../assets/img/mem/' . $user['mem_username'] . '.jpg'; ?>
        <a href="<?php if (file_exists($file)) { echo $file; } else { echo '../assets/img/mem/profile.png'; }?>" data-lightbox="<?php echo $user['mem_id']; ?>" data-title="<?php echo $user['mem_fullname']; ?>">
       <img src="<?php if (file_exists($file)) { echo $file; } else { echo '../assets/img/mem/profile.png'; }?>" width="120">
     </a>
     </td>
