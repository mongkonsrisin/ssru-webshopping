     ...
     <div class="jumbotron">
       ...
       <?php
        if(isset($_POST['save'])) {
          ...
          $sql = "INSERT INTO tbl_shipping(ship_name, ship_address,  ship_district, ship_amphoe, ship_province, ship_zipcode, ship_phone, ship_member)  VALUES('$name','$address','$district','$amphoe','$province','$zipcode','$phone','$id')";
          $result = mysqli_query($cnn,$sql);
       ...
       <div class="col-8">
        <input class="form-control" name="name" type="text" value="<?php echo $user[0]['mem_fullname']; ?>">
       </div>
     </div>
       ...
       <div class="col-8">
        <textarea class="form-control"  style="resize:none;height:150px" autocomplete="off" name="address"><?php if(isset($_POST['address'])) echo $_POST['address'];?></textarea>
       </div>
     </div>
     <div class="form-group row">
...
<input class="form-control" name="zipcode" type="text">
 ...
 <button class="btn btn-lg btn-primary" name="save" type="submit">SAVE</button>
